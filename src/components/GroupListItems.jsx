export const Categories = () => {
  return (
    <div className="w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white mt-14 md:mt-0">
      <a
        href="#"
        aria-current="true"
