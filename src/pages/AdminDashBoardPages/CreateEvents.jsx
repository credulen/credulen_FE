...
//       { value: "workshop", label: "Solutions" },
//     ],
//     []
//   );

//   // Memoize whether to show video URL input
//   const showVideoUrlInput = useMemo(() => {
//     return formData.eventType === "webinar";
//   }, [formData.eventType]);
...
//       ...prevData,
//       [name]: value,
//       // Clear videoUrl if changing from webinar to another type
//       ...(name === "eventType" && value !== "webinar" ? { videoUrl: "" } : {}),
//     }));
//   }, []);
...
//     if (formData.eventType === "webinar" && !formData.videoUrl) {
//       showSnackbar("Video URL is required for webinar events", "error");
//       return;
//     }
...
//               onChange={handleInputChange}
//               fullWidth
//               error={formData.eventType === "webinar" && !formData.videoUrl}
//             />
//           )}
//           <FormControl fullWidth>
//             <InputLabel id="speakers-select-label">Speakers</InputLabel>
