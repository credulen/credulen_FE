        ...
        try {
          ...
          if (solution) {
            setFormData({
              ...
              trainingDesc: solution.trainingDesc || "",
              price:
                solution.price !== undefined ? solution.price.toString() : "",
              isAllLevels: solution.isAllLevels || "Designed for All Levels",
              isExpertLed: solution.isExpertLed || "Expert-Led Content",
              duration: solution.duration || "3 Weeks Duration",
              isOnline: solution.isOnline || "100% Online Learning",
              prerequisites:
                solution.prerequisites ||
                "Basic knowledge of programming recommended",
              discountPercentage:
                solution.discountPercentage !== undefined
