          ...
          {events.map((event, index) => (
            <Card
              ...
              sx={{
                ...
                overflow: "hidden",
                transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",
                boxShadow: "0 4px 20px rgba(17, 11, 121, 0.1)",
                "&:hover": {
                  transform: "translateY(-8px) scale(1.02)",
                  boxShadow: "0 20px 40px rgba(17, 11, 121, 0.2)",
                },
              }}>
              <Box sx={{ position: "relative" }}>
                <CardMedia
                ...
                <Chip
                  ...
                  sx={{
                    ...
                    right: 8,
                    backgroundColor:
                      new Date(event.date) < new Date() ? "#110b79" : "#e4ff04",
                    color: "white",
                    fontWeight: 600,
                    fontSize: "0.75rem",
                  }}
      ...
      <Box sx={{ display: "flex", justifyContent: "center", mb: 4 }}>
        <Card
          sx={{
            maxWidth: { xs: 300, md: 500 },
            borderRadius: "16px",
            boxShadow: "0 8px 30px rgba(17, 11, 121, 0.1)",
            transition: "all 0.3s ease",
            "&:hover": {
              transform: "translateY(-4px)",
              boxShadow: "0 12px 40px rgba(17, 11, 121, 0.2)",
            },
          }}>
          <CardContent sx={{ p: 2 }}>
            <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
              ...
              <Box sx={{ flex: 1 }}>
                <Typography
                  variant="h6"
                  component="div"
                  sx={{ fontWeight: 700, color: "#080759", fontSize: "1rem" }}>
                  {speaker.name}
                </Typography>
                <Typography
                  variant="body2"
  ...
  return (
    <Box
      sx={{
        "& .slick-dots": {
          bottom: "-40px",
          "& li button:before": { color: "#110b79", fontSize: "10px" },
          "& li.slick-active button:before": { color: "#110b79" },
        },
        "& .slick-prev, & .slick-next": {
          zIndex: 2,
          "&:before": { fontSize: "20px", color: "#110b79" },
        },
        "& .slick-prev": { left: { xs: "-20px", md: "-40px" } },
        "& .slick-next": { right: { xs: "-20px", md: "-40px" } },
        ...(speakers.length <= 3 && {
    ...
    <Box>
      <IconButton
        sx={{
          ...
          borderRadius: "12px",
          padding: "8px",
          "&:hover": { backgroundColor: "#080759", transform: "scale(1.05)" },
          transition: "all 0.3s ease",
        }}
        onClick={handleOpen}
        aria-label="share">
  ...
  return (
    <Box>
      ...
      <Menu
        ...
        <MenuItem onClick={downloadICS}>
          <Download sx={{ mr: 1, color: "#e4ff04" }} /> Download ICS
        </MenuItem>
      </Menu>
    </Box>
  );
...
const LoadingSpinner = () => (
  <div className="fixed inset-0 flex items-center justify-center bg-white z-50">
    <CircularProgress size={50} sx={{ color: "#110b79" }} />
  </div>
);
    ...
    <Container
      ...
      <Box
        sx={{
          ...
          overflow: "hidden",
          position: "relative",
          boxShadow: "0 20px 60px rgba(17, 11, 121, 0.15)",
        }}>
        <Box
          sx={{
            position: "relative",
            height: { xs: 200, md: 500 },
            background: `linear-gradient(135deg, rgba(17, 11, 121, 0.8), rgba(17, 11, 121, 0.7)), url(${eventData.image})`,
            backgroundSize: "cover",
            backgroundPosition: "center",
            display: "flex",
            alignItems: "center",
          ...
          <Box sx={{ p: { xs: 2, md: 4 }, maxWidth: "800px" }}>
            <Chip
              label={isUpcoming ? "Upcoming Event" : "Past Event"}
              sx={{
                backgroundColor: isUpcoming ? "#110b79" : "#110b79",
                color: "white",
                fontWeight: 700,
                fontSize: { xs: "0.75rem", md: "1rem" },
                mb: 2,
        ...
        <Grid item xs={12} lg={8}>
            ...
            <Grid item xs={12} sm={6}>
              <Card
                sx={{
                  ...
                  backgroundColor: "#f8f9e6",
                  height: "100%",
                }}>
                <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
                  <MapPin size={20} color="#110b79" />
                  <Typography
                    variant="h6"
                    sx={{
                      ml: 1,
          ...
          <Card
            sx={{
              ...
              mb: 4,
              borderRadius: "20px",
              boxShadow: "0 10px 40px rgba(17, 11, 121, 0.1)",
            }}>
            <Typography
              variant="h4"
              sx={{
          ...
          <Card
            sx={{
              p: 2,
              borderRadius: "20px",
              background: "linear-gradient(135deg, #e8e8f5 0%, #f0f9ff 100%)",
              border: "2px solid #110b79",
              boxShadow: "0 15px 50px rgba(17, 11, 121, 0.15)",
            }}>
            <Typography
              variant="h4"
              sx={{
            ...
            <form onSubmit={handleRegisterSubmit} className="space-y-3">
                ...
                <Grid item xs={12} sm={6}>
                  <Box>
                    ...
                    <input
                      ...
                      value={formData.fullName}
                      onChange={handleInputChange}
                      className="w-full p-2 text-[0.875rem] border-2 border-gray-200 rounded-xl focus:border-primary-500 focus:outline-none transition-colors bg-white"
                      placeholder="Enter your full name"
                      required
                    />
                  </Box>
                ...
                <Grid item xs={12} sm={6}>
                  <Box>
                    ...
                    <input
                      ...
                      value={formData.email}
                      onChange={handleInputChange}
                      className="w-full p-2 text-[0.875rem] border-2border-gray-200 rounded-xl focus:border-primary-500 focus:outline-none transition-colors bg-white"
                      placeholder="Enter your email"
                      required
                    />
                  </Box>
                ...
                <Grid item xs={12} sm={6}>
                  <Box>
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      rows="2"
                      className="w-full p-2 text-[0.875rem] border-2 border-gray-200 rounded-xl focus:border-primary-500 focus:outline-none transition-colors bg-white resize-none"
                      placeholder="Why are you attending?"
                      required
                    />
                  </Box>
              ...
              <Box sx={{ textAlign: "center", mt: 2 }}>
                <button
                  type="submit"
                  className="bg-primary-500 text-white hover:bg-secondary-900 hover:text-primary-900 px-4 py-2 rounded-xl font-semibold text-sm hover:shadow-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed min-w-[180px]"
                  disabled={subLoading}>
                  {subLoading ? (
                    <>
                      <Loader className="animate-spin mr-1 inline" size={16} />
            ...
            {isPastWithVideo && (
              <Box sx={{ textAlign: "center", mt: 2 }}>
                <button
                  onClick={() => setShowVerifyModal(true)}
                  className="text-primary-500 hover:text-primary-900 font-medium text-sm hover:underline transition-colors">
                  Already registered? Watch recorded video →
                </button>
              </Box>
            )}
          ...
          <Box sx={{ position: "sticky", top: { xs: 10, md: 100 } }}>
            ...
            <Card
              sx={{
                ...
                mb: 3,
                borderRadius: "20px",
                background: "linear-gradient(135deg, #110b79 0%, #110b79 100%)",
                color: "white",
              }}>
              <Typography
                variant="h6"
            ...
            <Card
              ...
              <Button
                ...
                sx={{
                  ...
                  borderRadius: "12px",
                  background:
                    "linear-gradient(135deg, #110b79 0%, #e4ff04 100%)",
                  fontWeight: 600,
                  fontSize: "0.75rem",
                  "&:hover": {
                    transform: "translateY(-2px)",
                    boxShadow: "0 8px 25px rgba(17, 11, 121, 0.3)",
                  },
                  transition: "all 0.3s ease",
                }}>
                Join Our Telegram Community
              ...
              <form onSubmit={handleSubmit}>
                ...
                <Box sx={{ mb: 1 }}>
                  <input
                    type="email"
                    className="w-full p-2 text-[0.875rem] border-2 border-gray-200 rounded-xl focus:border-primary-500 focus:outline-none transition-colors"
                    placeholder="Enter your email address"
                    required
                    value={email}
                    onChange={(e) => setEmail(e.target.value)}
                ...
                <button
                  type="submit"
                  className="w-auto hover:bg-primary-900 bg-primary-500 text-white py-2 px-4 rounded-xl font-semibold text-sm hover:shadow-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-50"
                  disabled={subLoading}>
                  {subLoading ? (
                    <>
                      <Loader className="animate-spin mr-1 inline" size={16} />
      ...
      <Modal isOpen={showVerifyModal} onClose={() => setShowVerifyModal(false)}>
        <div className="text-center">
          <div className="bg-primary-50 rounded-full w-14 h-14 flex items-center justify-center mx-auto mb-2">
          ...
          <form onSubmit={handleVerifyEmail} className="space-y-2">
            <div className="text-left">
              ...
              <input
                type="email"
                className="w-full p-2 border-2 border-gray-200 rounded-xl focus:border-primary-500 focus:outline-none transition-colors text-[0.875rem]"
                value={verifyEmail}
                onChange={(e) => setVerifyEmail(e.target.value)}
                placeholder="Enter your registered email"
                required
            ...
            <button
              type="submit"
              className="w-full bg-primary-500 text-white py-2 px-4 rounded-xl font-semibold text-sm hover:shadow-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-50 flex items-center justify-center"
              disabled={isVerifying}>
              {isVerifying ? (
                <>
                  <Loader className="animate-spin mr-1" size={16} />
