...
//                       variant="h6"
//                       component="div"
//                       sx={{ fontWeight: 700, color: "#047481", mb: 0.5 }}>
//                       {speaker.name}
//                     </Typography>
//                     <Typography
//                       variant="body2"
...
//                     <Typography
//                       variant="body2"
//                       sx={{ color: "#198754", fontWeight: 600 }}>
//                       {speaker.CoName}
//                     </Typography>
//                   </Box>
//                 </Box>
...
//         }}>
//         <MenuItem onClick={() => handleShare("twitter")}>
//           <Twitter fontSize="small" sx={{ color: "#1DA1F2", mr: 2 }} />
//           Twitter
//         </MenuItem>
//         <MenuItem onClick={() => handleShare("facebook")}>
//           <Facebook fontSize="small" sx={{ color: "#4267B2", mr: 2 }} />
//           Facebook
//         </MenuItem>
//         <MenuItem onClick={() => handleShare("linkedin")}>
//           <LinkedIn fontSize="small" sx={{ color: "#0077b5", mr: 2 }} />
//           LinkedIn
//         </MenuItem>
//         <MenuItem onClick={() => handleShare("whatsapp")}>
//           <WhatsApp fontSize="small" sx={{ color: "#25D366", mr: 2 }} />
//           WhatsApp
//         </MenuItem>
//       </Menu>
//     </Box>
...
//       case "yahoo":
//         return `https://calendar.yahoo.com/?v=60&view=d&type=20&title=${title}&st=${startDate}&dur=0200&desc=${details}&in_loc=${location}`;
//       default:
//         return "";
//     }
//   };
...
//                 }}>
//                 <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
//                   <Calendar size={24} color="#047481" />
//                   <Typography
//                     variant="h6"
//                     sx={{ ml: 2, fontWeight: 700, color: "#047481" }}>
//                     Date & Time
//                   </Typography>
//                 </Box>
...
//                 }}>
//                 <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
//                   <MapPin size={24} color="#198754" />
//                   <Typography
//                     variant="h6"
//                     sx={{ ml: 2, fontWeight: 700, color: "#198754" }}>
//                     Location
//                   </Typography>
//                 </Box>
...
//               }}>
//               {isUpcoming
//                 ? "Register now to Secure a spot and also get a reminder on this event"
...
//                       value={formData.fullName}
//                       onChange={handleInputChange}
//                       className="w-full p-3 text-sm border-2 border-gray-200 rounded-xl focus:border-teal-600 focus:outline-none transition-colors bg-white"
//                       placeholder="Enter your full name"
//                       required
//                     />
//                   </Box>
...
//                       onChange={handleInputChange}
//                       rows="3"
//                       className="w-full p-3 text-sm border-2 border-gray-200 rounded-xl focus:border-teal-600 focus:outline-none transition-colors bg-white resize-none"
//                       placeholder="Tell us your motivation for attending..."
//                       required
//                     />
//                   </Box>
//                 </Grid>
...
//                 <button
//                   type="submit"
//                   className="bg-[#198754] text-white px-4 py-2 rounded-xl font-semibold text-lg hover:shadow-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed min-w-[200px]"
//                   disabled={subLoading}>
//                   {subLoading ? (
//                     <>
//                       <Loader className="animate-spin mr-2 inline" size={24} />
//                       Processing...
//                     </>
//                   ) : (
//                     <>
...
//                 <Box sx={{ display: "flex", alignItems: "center" }}>
//                   <Clock size={20} />
//                   <Typography sx={{ ml: 2 }}>2+ hours duration</Typography>
//                 </Box>
//               </Box>
//             </Card>
...
//                 <Typography
//                   variant="subtitle1"
//                   sx={{ fontWeight: 600, mb: 2, color: "#047481" }}>
//                   Subscribe to Newsletter
//                 </Typography>
//                 <Box sx={{ mb: 2 }}>
//                   <input
//                     type="email"
//                     className="w-full p-3 text-sm border-2 border-gray-200 rounded-xl focus:border-teal-600 focus:outline-none transition-colors"
//                     placeholder="Enter your email address"
//                     required
//                     value={email}
//                     onChange={(e) => setEmail(e.target.value)}
...
//                 <button
//                   type="submit"
//                   className="w-full bg-gradient-to-r from-teal-600 to-teal-700 text-white py-3 px-4 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-50"
//                   disabled={subLoading}>
//                   {subLoading ? (
//                     <>
...
//                       alignItems: "center",
//                     }}>
//                     <alertInfo.icon size={20} className="mr-2 flex-shrink-0" />
//                     <Typography variant="body2">{alertInfo.message}</Typography>
//                   </Box>
//                 )}
//               </form>
//             </Card>
...
//               {alertInfo.icon && (
//                 <alertInfo.icon className="h-6 w-6 flex-shrink-0" />
//               )}
...
//             <button
//               type="submit"
//               className="w-full bg-teal-600 to-teal-700 text-white py-3 px-4 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105 disabled:opacity-50 flex items-center justify-center"
//               disabled={isVerifying}>
//               {isVerifying ? (
//                 <>
//                   <Loader className="animate-spin mr-2" size={20} />
...
//             {verifyAlert && (
//               <Alert variant={verifyAlert.variant} className="mt-4">
//                 <div className="flex items-center gap-2">
//                   <verifyAlert.icon className="h-5 w-5 flex-shrink-0" />
//                   <AlertDescription>{verifyAlert.message}</AlertDescription>
//                 </div>
//               </Alert>
//             )}
//           </form>
