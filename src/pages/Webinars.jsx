...
const Webinars = () => {
  ...
  return (
    <div className="mt-[3rem] container mx-auto px-4 py-8 md:py-16 lg:px-12">
      <div className="pb-12">
        <h1 className="text-2xl font-semibold">Credulen Webinars</h1>
        <p className="mt-3">
          Elevate your expertise with Credulen Webinars! Empowering c-suite
          leaders, senior managers, developers, and tech enthusiasts with
          cutting-edge insights, news, and education on Big Data, AI, and
      ...
      <div className="pb-12">
        <div className="flex items-center mb-6">
          <EventAvailableIcon className="text-btColour mr-2" />
          <h2 className="text-xl font-medium">Upcoming Webinars</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div className="mt-24">
        <div className="flex items-center mb-6">
          <EventBusyIcon className="text-btColour mr-2" />
          <h2 className="text-xl font-medium">On Demand Webinars</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {pastEvents.length > 0 ? (
            pastEvents.map((event) => (
