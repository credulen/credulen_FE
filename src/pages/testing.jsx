...
// import { AiFillSolution } from "react-icons/ai";
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-5">
            <button
              ...
              className="w-full flex items-center px-5 py-3 text-sm bg-red-500 text-white rounded-md hover:bg-red-600 transition-colors"
            >
